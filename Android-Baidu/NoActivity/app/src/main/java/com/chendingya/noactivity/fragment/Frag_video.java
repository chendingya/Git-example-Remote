...
import com.chendingya.noactivity.adaptor.VideoAdapter;
...
public class Frag_video extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getActivity().findViewById(R.id.search2).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                System.err.println("jump to search");
    ...
    private void addVideo() {
         ...
         * 添加video data到List
         */
        videoList = JsonParse.getInstance().getVideoList(EmptyActivity.video_data);
    }
}