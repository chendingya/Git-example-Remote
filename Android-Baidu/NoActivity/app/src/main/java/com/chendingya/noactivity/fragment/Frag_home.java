...
import com.chendingya.noactivity.AddnewsActivity;
import com.chendingya.noactivity.EmptyActivity;
import com.chendingya.noactivity.JsonParse;
import com.chendingya.noactivity.WeatherActivity;
import com.chendingya.noactivity.adaptor.NewsAdapter;
import com.chendingya.noactivity.bean.News_bean;
//import com.chendingya.noactivity.Loading;
import com.chendingya.noactivity.R;
import com.chendingya.noactivity.EmptyActivity;
import com.chendingya.noactivity.search.SearchActivity;
//import com.chendingya.noactivity.SearchActivity;
...
public class Frag_home extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        weather.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                System.out.println("jump to weather");
        ...
        for (News_bean news: newsList) {
            System.err.println("newslist" + news.getTitle()+" "+ news.getSubtitle());
        }
    ...
    private void addNews() {
        ...
        if (file.exists()) {
            ...
            newsList = JsonParse.getInstance().getNewsList(EmptyActivity.news_data);
    }
